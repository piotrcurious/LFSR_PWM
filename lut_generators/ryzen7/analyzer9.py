...
class PWM_Analyzer_App:
    ...
    def setup_parsing_ui(self):
        ...
        ttk.Label(parse_frame, text="Select the C source file (.c or .h) containing the LFSR PWM Look-Up Table:", 
    ...
    def load_file_and_process(self):
        ...
        # Open file dialog - UPDATED to include *.h and make it the default extension
        file_path = filedialog.askopenfilename(
            defaultextension=".h", # Changed default extension to .h
            filetypes=[
